"""
Ball Tracker — Live RealSense + MAVLink terminal output
========================================================
- Live camera feed with ball detection overlay
- Prints MAVLink commands to terminal in real time
- No color filtering, detects any ball
- Grip triggered when ball is centered + close enough
...
# ── CONFIG ────────────────────────────────────────────────
MODEL_PATH = "/home/bartek/Studia/Orion/realsense/best.pt"  # auto-downloads if missing
GRIP_DISTANCE = 1.00  # [m] grip when closer than this
CENTER_THRESH = 0.16  # [m] acceptable XY error before descending
BALL_CLASS_ID = 2  # coco: sports ball
CONF_THRESHOLD = 0.40
